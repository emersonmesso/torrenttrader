...
// Account Page
$LANG["ACCEPTPM_WHICH_USERS"] = "Determina quais usuários podem enviar mensagens privadas.";
$LANG["ACCOUNT_ACTIVATED"] = "<p>Sua conta foi ativada!<br />Agora você pode fazer o login</p>";
$LANG["ACCOUNT_ACTIVATED_REST"] = "<b>Página principal</b></a> e comece a usar sua conta.</p>";
$LANG["ACCOUNT_ALREADY_CONFIRMED"] = "Conta já confirmada";
$LANG["ACCOUNT_BEFOR_USING"] = "<p>Antes de começar a usar";
$LANG["ACCOUNT_BEFOR_USING_REST"] = "pedimos-lhe que leia o <a href='faq.php'><b>FAQ</b></a>.</p>";
$LANG["ACCOUNT_CONFIRM_SENT_TO_ADDY_ADMIN"] = "Um administrador precisa aprovar sua conta antes de poder usá-la.";
$LANG["ACCOUNT_CONFIRM_SENT_TO_ADDY_REST"] = "<br/><br/>Você precisa ler e responder a este e-mail antes de poder usar sua conta.<br/>Se você não fizer isso, a nova conta será excluída automaticamente após alguns dias.";
$LANG["ACCOUNT_MY_TORRENTS"] = "Meus Torrents";
$LANG["ACCOUNT_MY_TORRENTS_UPLOADED"] = "Você enviou";
$LANG["ACCOUNT_MY_TORRENTS_UPLOADED_NO"] = "Eu não carreguei torrents";
$LANG["ACCOUNT_PRIVACY_LVL"] = "Nível de Privacidade";
$LANG["ACCOUNT_SEND_MSG"] = "Enviar uma Mensagem";
$LANG["ACCOUNT_SIGNUP_CONFIRMATION"] = "Confirmação de inscrição";
